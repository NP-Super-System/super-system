                        ...
                        }
                        {
                            eventData?.registeredUsers.map(ru => ru._id).includes(user?.id) ?
                                ...
                                <Button
                                    type='submit'
                                    variant='secondary'
                                    className={styles.registered_btn}
                        ...
                        <div className={styles.registered_users}>
                            {
                                ...
                                <>
                                {
                                    ...
                                    <div className={styles.all_registered_users}>
                                    {
                                        eventData.registeredUsers.map((ruser, i) => {
                                            const {userName, userEmail, userPicture} = ruser;
                                    ...
                                    <div className={styles.short_registered_users}>
